...
<html class="no-js" lang="en">
    <head>
        ...
        <title>Check-up Codes - Personal Portfolio</title>
        <meta name="description" content="">
        <meta name="viewport" content="width=device-width, initial-scale=1">

        <link rel="shortcut icon" type="image/ico" href="{{ asset('backend/images') }}/favicon.ico">        <!-- Place favicon.ico in the root directory -->
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="copyright__text text-center">
                                <p>Copyright @ Check-up Codes 2022 All right Reserved</p>
                            </div>
                        </div>
                    </div>
                </div>
