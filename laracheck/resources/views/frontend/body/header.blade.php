                        ...
                        <nav class="menu__nav">
                            ...
                            <div class="navbar__wrap main__menu d-none d-xl-flex">
                                <ul class="navigation">
                                    ...
                                    <li class="{{$route == 'home.about' ? 'active' : ''}}"><a href="{{ route('home.about') }}">Services</a></li>
                                    <li class="{{$route == 'index.portfolio' ? 'active' : ''}}"><a href="{{ route('index.portfolio') }}">Portfolio</a></li>
